...
namespace Nut.Demo {
    public partial class MoneyToText : Form {
        public MoneyToText() {
            InitializeComponent();
            cmbLang.DataSource = new List<string>() { "en", "es", "fr", "ru", "tr", "ua", "bg", "am","pl", "pt", "de", "lv" };
            cmbCurrency.DataSource = new List<string>() { "usd", "eur", "rub", "try", "uah", "bgn", "etb", "pln", "ars", "brl", "cad" };
        }
